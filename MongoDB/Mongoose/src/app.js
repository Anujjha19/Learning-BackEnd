...
//Models is a wrapper on Mongoose Schema , It provides an interface to the database for CRUD records 
//Collection creation 
...
const getUsingComparisonOperator = async () => {
    try {
        // const res = await Playlist.find();
        // const res = await Playlist.find( { ctype : "Back End" } );
        const res = await Playlist.find(
